                        ...
                        <div class="col-4 mb-3">
                            ...
                            <select name="category_id" class="form-control">
                                @foreach($categories as $category)
                                    <option
                                        value="{{ $category['id'] }}" {{ $category['id'] == $user['category_id'] ? 'selected' : '' }}>{{ $category['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-8"></div>
                        <div class="col-4 mb-3">
                            ...
                            <select name="prof_1" class="form-control">
                                ...
                                @foreach($services as $service)
                                    <option
                                        value="{{ $service['id'] }}" {{ ((isset($prof[1])) && ($prof[1]['id'] == $service['id'])) ? 'selected' : '' }} >{{ $service['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
                            ...
                            <select name="prof_2" class="form-control">
                                ...
                                @foreach($services as $service)
                                    <option
                                        value="{{ $service['id'] }}" {{ ((isset($prof[2])) && ($prof[2]['id'] == $service['id'])) ? 'selected' : '' }} >{{ $service['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
                            ...
                            <select name="prof_3" class="form-control">
                                ...
                                @foreach($services as $service)
                                    <option
                                        value="{{ $service['id'] }}" {{ ((isset($prof[3])) && ($prof[3]['id'] == $service['id'])) ? 'selected' : '' }} >{{ $service['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
                            ...
                            <select name="lang_1" class="form-control">
                                ...
                                <option
                                    value="{{ $lan['id'] }}" {{ ((isset($lang[1])) && ($lang[1]['id'] == $lan['id'])) ? 'selected' : ''}}>{{ $lan['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
                            ...
                            <select name="lang_2" class="form-control">
                                ...
                                @foreach($languages as $lan){
                                <option
                                    value="{{ $lan['id'] }}" {{ ((isset($lang[2])) && ($lang[2]['id'] == $lan['id'])) ? 'selected' : ''}}>{{ $lan['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
                            ...
                            <select name="lang_3" class="form-control">
                                ...
                                @foreach($languages as $lan){
                                <option
                                    value="{{ $lan['id'] }}" {{ ((isset($lang[3])) && ($lang[3]['id'] == $lan['id'])) ? 'selected' : ''}}>{{ $lan['title_ru'] }}</option>
                                @endforeach
                            </select>
                        </div>
