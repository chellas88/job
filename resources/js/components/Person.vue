    ...
    <div class="container">
        <form enctype="multipart/form-data" method="post" action="/en/admin/user">
            ...
            <div class="row">
                ...
                <div class="col-4 mb-3">
                    <label>Фамилия</label>
                    <input type="text" class="form-control" v-model="form.surname" name="surname" required>
                </div>
                <div class="col-4"></div>
                <div class="col-4 mb-3">
                    <label for="country">Страна</label>
                    <input id="country" class="form-control" v-model="form.country" name="country" required>
                </div>
                <div class="col-4">
    ...
    data() {
        return {
            ...
            form: {
                ...
                surname: (this.old.surname) ? this.old.surname : '',
