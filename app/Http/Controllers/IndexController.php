...
class IndexController extends Controller
{
    public function homePage(){
        ...
        $subcategory = Subcategory::orderBy('title_'.App::currentLocale())->get();
        ...
        return view('welcome', compact('category', 'country', 'reviews', 'recommended', 'personsCount', 'companiesCount', 'countriesCount', 'languages', 'subcategory'));
    }
